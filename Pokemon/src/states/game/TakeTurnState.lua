            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local hp_increase, attack_increase, def_increase, speed_increase = self.playerPokemon:levelUp()

                        gStateStack:push(BattleMessageState('Congratulations! Level Up!', function() end))
                        gStateStack:push(BattleStatsMenuState(self.battleState, hp_increase, attack_increase, def_increase, speed_increase,
                        function()
                            -- pop BattleMessageState as it does not get "Enter" input from StatsMenu
                            gStateStack:pop()
